...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('images/jufman.png') }}" alt="JUFMAN Kitchen Designs" height="60">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#portafolio">Portfolio</a>
                </li>
                <li class="nav-item">
            ...
            <div class="language-buttons ms-3 d-flex">
                <a href="{{ url('/') }}" class="lang-btn {{ Request::is('/') ? 'active' : '' }}" title="Spanish">
                    ES
                </a>
                <a href="{{ route('jufman') }}" class="lang-btn {{ Request::is('jufman') ? 'active' : '' }}" title="English">
                    EN
                </a>
            </div>
